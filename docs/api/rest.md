...
The D&D SRD core spell slice now includes Acid Arrow, Acid Splash, Aid, Bane, Bless, Burning Hands, Color Spray, Command, Guiding Bolt, Magic Missile, and Thunderwave. `spellSlotLevel` upcasting now covers Acid Arrow initial/secondary damage, Aid numeric hit-point increases, Burning Hands, Guiding Bolt, Magic Missile dice-plus-constant scaling, and Thunderwave; actor-level cantrip scaling covers Acid Splash, Fire Bolt, Sorcerous Burst, Eldritch Blast, and Starry Wisp.
