...
| D&D SRD core spell and cantrip scaling evidence | The 2026-05-02 core spell slice in `docs/verification/mvp-progress.md` verifies Acid Arrow, Acid Splash, Aid, Bane, Bless, Burning Hands, Color Spray, Command, Guiding Bolt, Magic Missile, and Thunderwave compendium entries; actor-level cantrip scaling for Acid Splash, Fire Bolt, Sorcerous Burst, Eldritch Blast, and Starry Wisp; Aid numeric upcasting; Magic Missile dice-plus-constant upcasting; bearer-token compendium add for seven roll-tested entries; and bearer-token Acid Arrow, Acid Splash, Aid, Burning Hands, Guiding Bolt, Magic Missile, and Thunderwave roll evidence. |
...
| D&D SRD magic item evidence | The 2026-05-02 magic item compendium and protection automation slice in `docs/verification/mvp-progress.md` verifies `48` representative SRD magic-item entries, rarity/attunement/charge/crafting metadata, protection-item AC and saving throw automation, Bracers of Defense armor/shield exclusion, Staff of Striking damage quick rolls, and built-API bearer-token manual evidence over `276` compendium entries. |
