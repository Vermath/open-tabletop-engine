...
- Advanced fog UX polish such as freehand brush smoothing; polygon reveal, hide/erase brush regions, fog deletion, fog undo/history, and multi-scene fog presets are now verified.
