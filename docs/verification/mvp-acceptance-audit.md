...
- Advanced fog UX polish such as freehand brush smoothing and multi-scene fog presets; polygon reveal, hide/erase brush regions, fog deletion, and fog undo/history are now verified.
