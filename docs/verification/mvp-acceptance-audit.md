...
| D&D SRD magic item evidence | The 2026-05-02 magic item compendium/protection automation slice and potion/Spell Scroll slice in `docs/verification/mvp-progress.md` verify `82` first-class SRD magic-item entries plus existing Potion of Healing and low-level scroll entries, rarity/attunement/charge/crafting metadata, potion-effect metadata, Spell Scroll level/DC/attack metadata, protection-item AC and saving throw automation, Bracers of Defense armor/shield exclusion, Staff of Striking damage quick rolls, potion healing/damage quick rolls, and built-API bearer-token manual evidence over `310` compendium entries. |
