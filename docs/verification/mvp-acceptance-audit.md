...
- First-class password reset UI, MFA, and SCIM/organization sync beyond the verified API-backed account/session operations and server-admin audit export.
