...
| System runtime behavior with permission boundaries | `3a3e81a feat: add plugin and system runtimes` plus the rules compendium/conditions, character builder/advancement, encounter math, character importer, action automation, rest/resource automation, action resource consumption, target effect application, D&D 5.5e SRD focus, SRD spell upcasting, SRD saving throw proficiency, SRD skill proficiency, SRD tool proficiency, SRD equipment purchasing, SRD monster XP/CR encounter, SRD monster action automation, SRD character origin choice, SRD expanded spell/weapon compendium, SRD Armor Class automation, SRD Fighter Second Wind automation, SRD Fighter level-2 feature automation, SRD Fighter level-5 feature automation, SRD Barbarian Rage/Reckless Attack automation, SRD Cleric level-2 Channel Divinity automation, SRD Cleric level-5 Sear Undead automation, SRD Wizard Arcane Recovery automation, and SRD Rogue Sneak Attack/Cunning Strike automation slices in `docs/verification/mvp-progress.md`; tests and browser/manual evidence now prioritize `dnd-5e-srd` with SRD 5.2.1 registration, Fighter/Barbarian/Cleric/Wizard/Rogue templates, SRD background/species origin catalogs, create-time origin application, SRD compendium entries, bounded expanded spell/weapon/armor entries, fixed and secondary spell damage quick rolls, computed Armor Class from Leather Armor/Chain Mail/Shield items, Fighter Second Wind, Action Surge, Tactical Mind, Extra Attack, and Tactical Shift automation, Barbarian Rage, Rage Damage, Danger Sense, Reckless Attack, Extra Attack, and Fast Movement automation, Cleric Channel Divinity, Divine Spark, Turn Undead, and Sear Undead automation, Wizard Arcane Recovery rest automation, Rogue Sneak Attack and Cunning Strike automation, Second Wind, Rage, Action Surge, Channel Divinity, and Arcane Recovery resource consumption, Tactical Mind's Second Wind consumption, Extra Attack weapon attack-count metadata, Tactical Shift Second Wind metadata, Barbarian Rage/Reckless/Danger Sense resource/save/damage/advantage metadata, Divine Spark, Turn Undead, and Sear Undead save/resource/damage metadata, Arcane Recovery selected spell-slot recovery metadata, Rogue Sneak Attack scaling damage metadata, Rogue Cunning Strike save/rider metadata, Short Rest one-use Second Wind, Rage, Channel Divinity, and selected Arcane Recovery spell-slot recovery, Short Rest Action Surge recovery, Long Rest all-use recovery including Arcane Recovery restoration, character import normalization, level advancement, SRD monster stat blocks, monster actor creation from threat ids, monster attack/damage quick rolls, CR/XP threat planning, 2024 Basic Rules encounter XP thresholds, spell-slot-consuming actions, Healing Word/Cure Wounds/Chromatic Orb/Ray of Sickness upcasting, Ice Knife secondary damage upcasting, saving throw quick rolls, class save proficiencies, skill and tool check quick rolls, class/template/background skill and tool proficiencies, SRD currency/equipment purchasing with insufficient-funds protection, Shortbow/Dagger/Quarterstaff/Spear weapon data, target HP healing/damage application, hit dice, spell slots, short/long rest recovery, and permission denial before resource mutation. Generic Fantasy, Stellar Frontiers, and Mystic Noir remain verified demo runtimes for later expansion, but the primary gap-closing rules direction is D&D SRD. |
...
- A complete rules engine for every game system; the MVP now prioritizes D&D 5.5e SRD with `dnd-5e-srd` registration, SRD 5.2.1-oriented Fighter/Barbarian/Cleric/Wizard/Rogue templates, SRD background/species origin catalogs, create-time origin application, compendium entries, bounded expanded spell/weapon/armor entries, computed Armor Class from SRD armor/shield items, character import, guided advancement, action formulas, Fighter Second Wind, Action Surge, Tactical Mind, Extra Attack, and Tactical Shift class-feature quick rolls/resource/metadata automation, Barbarian Rage, Rage Damage, Danger Sense, Reckless Attack, Extra Attack, and Fast Movement quick rolls/resource/rest/metadata automation, Cleric Channel Divinity, Divine Spark, Turn Undead, and Sear Undead quick rolls/resource/metadata automation, Wizard Arcane Recovery resource/rest/selected spell-slot recovery automation, Rogue Sneak Attack and Cunning Strike quick rolls/metadata automation, stateful spell-slot consumption, Healing Word/Cure Wounds/Chromatic Orb/Ray of Sickness upcasting, Ice Knife secondary damage upcasting, fixed and secondary spell damage quick rolls, saving throw quick rolls, class save proficiencies, skill and tool check quick rolls, class/template/background skill and tool proficiencies, SRD currency/equipment purchasing, Shortbow/Dagger/Quarterstaff/Spear weapon data, target damage/healing application, hit dice, spell slots, rest recovery including Short Rest one-use Second Wind, Rage, and Channel Divinity recovery, Short Rest Action Surge recovery, Short Rest selected Wizard Arcane Recovery, and Long Rest all-use Fighter/Barbarian/Cleric/Wizard resource recovery, SRD monster stat blocks, monster actor creation, monster attack/damage quick rolls, CR/XP encounter threat budgets, and 2024 Basic Rules encounter XP thresholds. Remaining non-MVP D&D work is full SRD-scale spell/equipment/magic-item content coverage, broader class/subclass feature automation beyond Fighter levels 1-5, Barbarian level-5 Rage/Reckless Attack coverage, Cleric level 5, Wizard Arcane Recovery, and Rogue level-5 Sneak Attack/Cunning Strike, more complete species trait automation, and full SRD-scale monster/action coverage beyond the current SRD threat catalog. Generic Fantasy, Stellar Frontiers, and Mystic Noir remain demo runtimes for later expansion.
