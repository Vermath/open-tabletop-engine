...
| Gate | Result |
|---|---|
| Focused regressions for FF-001 through FF-032 | Passed during remediation |
| Web typecheck and full web suite | Passed: 150 files and 763 tests after FF-032 |
