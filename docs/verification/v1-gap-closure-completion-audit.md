...
| Broader cross-organization administration/isolation | `docs/prd-v1-gap-closure.md` still calls out coverage beyond owner/admin membership, active-session switching, workspace creation, and invite lifecycle | Incomplete unless implemented or explicitly descoped by owner |
...
- Broader cross-organization administration/isolation needs implementation beyond the current owner/admin membership, workspace switching, workspace creation, and invite lifecycle slice, or explicit owner descope.
