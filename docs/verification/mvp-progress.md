...
- D&D SRD magic-item coverage now includes `48` representative armor/ammunition/weapon/shield/ring/wand/staff/wondrous entries, protection-item AC/save automation, Bracers of Defense armor/shield exclusion, Staff of Striking damage formulas, charges, rarity, attunement, and bearer-token manual evidence. Remaining equipment content work is full SRD-scale magic item coverage beyond this representative slice, plus deeper automation for item effects that currently remain metadata-only.
