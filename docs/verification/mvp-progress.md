...
- D&D 5.5e SRD is now the primary rules focus with SRD 5.2.1 system registration, Fighter/Barbarian/Bard/Cleric/Paladin/Druid/Wizard/Rogue templates, SRD character origin catalogs, create-time background/species application, SRD-oriented compendium entries, bounded expanded spell/weapon/armor compendium coverage, computed Armor Class from SRD armor/shield items, Fighter Second Wind, Action Surge, Tactical Mind, Extra Attack, and Tactical Shift class-feature automation, Barbarian Rage, Rage Damage, Danger Sense, Reckless Attack, Extra Attack, and Fast Movement automation, Bard Bardic Inspiration, Jack of All Trades, Font of Inspiration, and Charisma spellcasting automation, Cleric Channel Divinity, Divine Spark, Turn Undead, and Sear Undead automation, Paladin Lay On Hands, Divine Smite, Paladin's Smite, Extra Attack, Faithful Steed, half-caster spell-slot, and Charisma spellcasting automation, Druid Wild Shape, Wild Companion, Wild Resurgence, full-caster spell-slot, and Wisdom spellcasting automation, Wizard Arcane Recovery rest automation, Rogue Sneak Attack and Cunning Strike automation, fixed and secondary spell damage formulas, spell-slot-consuming action use, target damage/healing application, supported Healing Word/Cure Wounds/Chromatic Orb/Ray of Sickness/Ice Knife/Divine Smite upcasting, saving throw quick rolls, class save proficiencies, skill and tool check quick rolls, class/template/background skill and tool proficiencies, SRD currency/equipment purchasing, guided level advancement, character import normalization, SRD monster stat blocks, monster actor creation, monster attack/damage quick rolls, CR/XP threat budgets, 2024 Basic Rules encounter XP thresholds, hit dice, spell slots, short/long rest recovery including Second Wind's one-use Short Rest, Rage's one-use Short Rest, Bardic Inspiration's Font-enabled Short Rest recovery, Channel Divinity's one-use Short Rest, Arcane Recovery's selected Short Rest spell-slot recovery, Wild Shape's one-use Short Rest recovery, and all-use Long Rest cadence plus Action Surge, Paladin's Smite, Faithful Steed, Lay On Hands, and Wild Resurgence recovery, API tests, and manual API acceptance evidence. Remaining D&D rules ecosystem work is full SRD-scale spell/equipment/magic-item content coverage, broader class/subclass feature automation beyond the currently covered early-level class slices, more complete species trait automation, and full SRD-scale monster/action coverage beyond the current SRD threat catalog. Generic Fantasy, Stellar Frontiers, and Mystic Noir remain available as demo systems for later expansion, but they are no longer the primary gap-closing direction.
