...
- D&D SRD mundane equipment coverage now includes the full armor table and weapon table with armor AC metadata, weapon range/properties/mastery metadata, purchase behavior, sheet AC updates, and item quick-roll evidence. Remaining equipment content work is adventuring gear, broader tool packs, and magic items beyond the current mundane equipment slice.
