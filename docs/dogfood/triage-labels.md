# Dogfood Triage Labels

Use these labels for v0.3 outside dogfood reports.

| Label | Use |
| --- | --- |
| `v0.3` | Any outside dogfood release report. |
| `dogfood` | Reports from real table use or runbook smoke. |
| `gm-ux` | GM setup, scene, token, journal, combat, or content import UX. |
| `player-ux` | Join flow, player visibility, owned token movement, or table feedback. |
