...
describe("dnd 5.5e srd rules", () => {
  ...
  it("exposes first-class SRD templates, compendium entries, and quick rolls", () => {
    ...
    const levelFiveClericOvercapWisdomActor: Actor = { ...levelFiveClericActor, data: { ...levelFiveClericActor.data, attributes: { ...levelFiveClericActor.data.attributes, wisdom: 1000 } } };
